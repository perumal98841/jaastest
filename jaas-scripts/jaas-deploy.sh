...
if [ "$Environment" == "DEV" ]; then
    ...
    terraform init jaas-terraform/env/dev
    terraform plan jaas-terraform/env/dev
    terraform apply -auto-approve jaas-terraform/env/dev
	ls -ls
    ...
    terraform init jaas-terraform/env/prod
    terraform plan jaas-terraform/env/prod
    terraform apply -auto-approve jaas-terraform/env/prod
	ls -ls

...
docker run -itd -p 80:8080 -p 50000:50000 -v /efs-volume/jaas:/var/jenkins_home 152429829684.dkr.ecr.us-east-1.amazonaws.com/jaas-prod:jaas-v1.3
...
module "jaas_lc_asg" {
  ...
  image_id                     = "ami-01e806d283c850516"
